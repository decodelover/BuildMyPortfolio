...
export const PLAN_DEFINITIONS: Record<string, SubscriptionPlan> = {
  ...
  PRO: {
    ...
    features: [
      ...
      "Remove BuildMyPortfolio Watermark",
  ...
  BUSINESS: {
    planId: "BUSINESS",
    name: "Business",
    description: "For agencies, studios, and power creators managing multiple clients.",
    monthlyPriceUsd: 39,
    yearlyPriceUsd: 384,
    currency: "USD",
    features: [
      "25 Published Portfolio Sites",
